    ...
    if user == 'A' and userPassword == 'admin':
        ...
        while True:
            ...
            if op == '1':
                ...
                choice = input("Enter 'I' for the subject to be deleted by id else enter 'S' to be deleted by subject name : ").upper()
        ...
        while True:
            ...
            if op == '1':
                ...
                while True:
                    ...
                    try:
                        if s.verifySubjectCode(subjectId1):
                            break
                ...
                while True:
                    ...
                    try:
                        if s.verifySubjectCode(subjectId2):
                            break
